...
OrganID = {
    ...
    "SCord": 65, "SpinalCore": 65, "Brain": 18,

    "Skin": 11, "Muscle": 13,
    "Eyes": 22, "Heart": 26, "Breast": 19, "Lung": 33,
    "Ovary": 86, "Bladder":15,
    "Intestine": 44, "GallBladder":24, "ParotidGland":43,
    "Kidney":28,"Liver":32, "Pancrease":38,
    "Spleen":66, "Stomach":67, "Thyroid":70,
}
...
class JpgProcessor(object):
    ...
    def convert_organ_jpg2nii(self, organ):
        """
    ...
    def combine_organs(self):
        ...
        for organ in os.listdir(folder_nii):
            if organ in STOP_ORGAN_in_All_Organs_nii:
                continue
            else:
                pass
